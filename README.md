...
Como este armazenamento aceita apenas strings de texto, foi aplicada a função `JSON.stringify` para converter a lista de objetos em texto antes de salvar. Ao carregar a página, é feito o inverso com `JSON.parse`.
